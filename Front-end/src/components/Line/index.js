...
import {updateObjet, deleteObjet} from '../../Api/ApiStock';


const Line = ({data, setStock, isLogged}) => {
    ...
    return (
                ...
                <tr>
                    ...
                    <td>{amount}</td>
                    {
                      isLogged === true && (
                        <>
                          <td><button onClick={() => addObject(data, amount)} type="button" className="btn btn-outline-secondary"><i class="fas fa-plus"></i></button></td>
                          <td><button onClick={() => lostObject(data, amount)} type="button" className="btn btn-outline-secondary"><i class="fas fa-minus"></i></button></td>
